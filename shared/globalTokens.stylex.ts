...
export const buttons = stylex.defineVars({});
...
export const gradient = stylex.defineVars({
  redOrange: `linear-gradient(90deg, rgba(228,0,75,1) 0%, rgba(246,165,0,1) 100%)`,
  greenYellow: `linear-gradient(90deg, rgba(81,173,50,1) 0%, rgba(255,212,0,1) 100%)`,
});
